...
class ItemReviewsControllerTest < ActionController::TestCase
  ...
  test "should create item_review" do
    assert_difference('ItemReview.count') do
      post :create, item_review: { date: @item_review.date, item_id: @item_review.item_id, rating: @item_review.rating, restaurant_id: @item_review.restaurant_id, review: @item_review.review, user_id: @item_review.user_id }
    end
  ...
  test "should update item_review" do
    patch :update, id: @item_review, item_review: { date: @item_review.date, item_id: @item_review.item_id, rating: @item_review.rating, restaurant_id: @item_review.restaurant_id, review: @item_review.review, user_id: @item_review.user_id }
    assert_redirected_to item_review_path(assigns(:item_review))
  end
